...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero */}
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-12" data-aos="fade-up">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Simple Tax Tracking for Canadian Sole Proprietors</h2>
        <p className="text-lg text-gray-700 mb-6 max-w-xl">
          Track your income, expenses, GST/HST, and estimated tax owing — all in one place. Built to match the CRA T2125 form.
        </p>
        <Link href="/signup" className="bg-blue-600 text-white px-6 py-3 rounded text-lg hover:bg-blue-500">Start Free for 30 Days
        </Link>
      </main>
